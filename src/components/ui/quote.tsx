...
export function Quote() {
  return (
    <section className="w-full bg-white dark:bg-background py-12 md:py-24 text-black dark:text-white transition-colors duration-300">
      <div className="mx-auto max-w-7xl px-6 xl:px-0">
        <div className="relative flex flex-col items-center border border-blue-600 bg-white dark:bg-background transition-colors duration-300">
          <DotPattern width={5} height={5} />

          <div className="absolute -left-1.5 -top-1.5 h-3 w-3 bg-blue-600 text-white" />
          <div className="absolute -bottom-1.5 -left-1.5 h-3 w-3 bg-blue-600 text-white" />
          <div className="absolute -right-1.5 -top-1.5 h-3 w-3 bg-blue-600 text-white" />
          <div className="absolute -bottom-1.5 -right-1.5 h-3 w-3 bg-blue-600 text-white" />

          <div className="relative z-20 mx-auto max-w-7xl rounded-[40px] py-6 md:p-10 xl:py-20">
            <p className="md:text-md text-xs text-blue-600 lg:text-lg xl:text-2xl">
              I believe
            </p>
