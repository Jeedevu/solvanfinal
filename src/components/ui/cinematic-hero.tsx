...
export function CinematicHero({ 
  brandName = "Solvan Media",
  tagline1 = "Start your journey,",
  tagline2 = "not just the days.",
  cardHeading = "Accountability, redefined.",
  cardDescription = <><span className="text-white font-semibold">Solvan</span> empowers sponsors and sponsees in 12-step recovery programs with structured accountability, precise sobriety tracking, and beautiful visual timelines.</>,
  metricValue = 365,
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .to([".hero-text-wrapper", ".bg-grid-theme"], { scale: 1, filter: "blur(0px)", opacity: 1, ease: "power2.inOut", duration: 1.8 }, "pullback")
